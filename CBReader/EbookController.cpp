...
public:
    ...
    EbookFormattingThread(CanvasDrawingSession^ g, Doc doc, HtmlFormatterArgs *args,
...
EbookFormattingThread::EbookFormattingThread(CanvasDrawingSession^ g, Doc doc, HtmlFormatterArgs *args, EbookController *ctrl, int reparseIdx, ControllerCallback *cb):
...
bool EbookFormattingThread::Format()
{
    ...
    HtmlFormatter *formatter = doc.CreateFormatter(g,formatterArgs);
